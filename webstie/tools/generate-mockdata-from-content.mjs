...
function generateMockDataFile() {
  console.log('🚀 Generating mockData from content...\n');
...
`;
  ...
  console.log('✅ Generated: project-hub-x/integrations/cms/mock-data.ts');
  console.log('');
...
try {
  ...
  console.error('❌ Error generating mockData:', error);
  process.exit(1);
}
